...
public class ArtsRecommendPlayerActivity extends BaseActivity {
    ...
    protected int getLayoutId() {
        return R.layout.activity_aets_recommend_player;
    }
    ...
    protected void initView() {
        ...
        detailPlayer.getFullscreenButton().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                detailPlayer.startWindowFullscreen(ArtsRecommendPlayerActivity.this, true, true);
            }
        });
    ...
    protected void initNewSave(Bundle savedInstanceState) {
        ...
        commonAdapter = new CommonAdapter<RecomBean>(this, R.layout.item_rv_video_recommend_layout, recomBeanList) {
            ...
            protected void convert(ViewHolder holder, RecomBean recomBean, int position) {
                ...
                ImageUtils.loadImgUrl(ArtsRecommendPlayerActivity.this, recomBean.getImgUrl(), imageView);
            }
        };
        ...
        commonAdapter.setOnItemClickListener(new MultiItemTypeAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, RecyclerView.ViewHolder holder, int position) {
                ...
                Intent intent = new Intent(ArtsRecommendPlayerActivity.this, ArtsRecommendPlayerActivity.class);
    ...
    protected void initData() {
        ...
        if (!TextUtils.isEmpty(imgUrl)) {
            ImageUtils.loadImgAdUrl(ArtsRecommendPlayerActivity.this, imgUrl, imageView);
    ...
    private void getBottomRecList() {
        ...
        new Thread(() -> {
            List<RecomBean> recomList = RecommendJsoupController.Instance().getArtSportRecommendList(Https.QIU_LY_ARTS_RECOMM2_HTTP, "");
    ...
    private void getTvPlayerData() {
        try {
            ...
            new Thread(() -> {
                pm4Url = VideoJsoupController.Instance().getArtRecommendVideoData(hrefUrl);
                ...
                if (!TextUtils.isEmpty(pm4Url)) {
                    ...
                    ToastUtils.showToast(ArtsRecommendPlayerActivity.this, getString(R.string.network_fail_string));
                }
            }).start();
