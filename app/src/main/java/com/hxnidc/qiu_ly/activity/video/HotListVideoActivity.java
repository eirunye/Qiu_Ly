...
public class HotListVideoActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener, LoadMoreWrapper.OnLoadMoreListener {
    ...
    protected int getLayoutId() {
        return R.layout.activity_hot_list_video;
    }
    ...
    protected void initNewSave(Bundle savedInstanceState) {
        ...
        loading_text.setOnClickListener(v -> {
            onLoadMoreRequested();
        });
        ...
        hotMultiAdapter.setOnItemClickListener(new MultiItemTypeAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, RecyclerView.ViewHolder holder, int position) {
                ...
                Intent intent = new Intent(HotListVideoActivity.this, JokeTvActivity.class);
    ...
    public void onLoadMoreRequested() {
        ...
        try {
            ...
            new Thread(() -> {
                ...
                List<FirstVideoModel> firstModelList = VideoJsoupController.Instance().firstVideoData(Https.QIU_LY_HOT_LIST_HTTP + page + Https.QIU_LY_HTML_STRING, "http://dv.dzwww.com/gn");
                if (firstModelList == null || firstModelList.size() <= 0) {
                    UIUtils.post(() -> {
                        progressBar.setVisibility(View.GONE);
