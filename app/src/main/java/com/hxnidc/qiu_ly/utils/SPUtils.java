...
public class SPUtils {
    ...
    public void putObject(String key, Object obj) {
        editor.putString(key, new Gson().toJson(obj)).apply();
    }

//    public String getObject(String key) {
//        String s = sp.getString(key, null);
//        new Gson().fromJson(key, new TypeToken<T>() {}.getType());
//        return  //sp.get new Gson().fromJson(key, new TypeToken<T>() {}.getType());
//    }
